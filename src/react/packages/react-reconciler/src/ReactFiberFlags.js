...
// 代表当前fiber或者子孙fiber内存在需要移动或者插入的dom元素或者文本 【HostComponent/HostText】
export const Placement = /*                    */ 0b00000000000000000000000010; 
// 触发类组件的mount/update生命周期钩子函数 hostComponent发生属性变化 hostText发生文本变化 函数组件定义了useLayoutEffect
export const Update = /*                       */ 0b00000000000000000000000100;
export const PlacementAndUpdate = /*           */ Placement | Update;
// 当前节点存在删除操作
export const Deletion = /*                     */ 0b00000000000000000000001000;
// 子节点存在需要删除的dom元素或者文本 【HostComponent/HostText】
export const ChildDeletion = /*                */ 0b00000000000000000000010000;
// 清空HostComponent.即dom节点的文本内容
export const ContentReset = /*                 */ 0b00000000000000000000100000;
// 调用this.setState函数时传递了回调函数参数
...
// 触发类组件的getSnapShotBeforeUpdate生命周期函数
